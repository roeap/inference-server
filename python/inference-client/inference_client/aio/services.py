...
from inference_client.gen.inference.model_repository import (
...
class AsyncModelRepositoryClient(_BaseGrpcClient[ModelRepositoryServiceStub]):
    def __init__(
        self,
        host: str = "localhost",
        port: int = 8081,
...
class AsyncInferenceClient(_BaseGrpcClient[GrpcInferenceServiceStub]):
    def __init__(
        self,
        host: str = "localhost",
        port: int = 8081,
        ...
        """Asynchronous client for model inference with a V2 inference protocol compliant server.
